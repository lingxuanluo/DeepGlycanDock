...
for protein in tqdm(proteins):
        ...
        if not os.path.exists(target_filename):
            target_filename = os.path.join(args.data_dir,protein,f'{protein}_protein_preprocessed.pdb')
        if os.path.exists(target_filename):
            ...
            if os.path.exists(ref_ligand_filename):
                ...
                pocket = os.path.join(args.surface_out_dir, protein, f'{protein}_protein_preprocessed_8A.pdb')
                surface = os.path.join(args.surface_out_dir, protein, f'{protein}_protein_preprocessed_8A.ply')
