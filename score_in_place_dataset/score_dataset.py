...
class ScreenDataset(Dataset):
    def __init__(self, pocket_path, ligands_path, ref_ligand, ligand_embedding=None, surface_path=None, pocket_center=None,transform=None, cache_path='data/cache', split_path='data/',
        ...
        self.ligand_embedding = ligand_embedding
    ...
    def get(self, idx):
        ...
        complex_graph['ligand'].ligand_embedding = torch.tensor(self.ligand_embedding)
