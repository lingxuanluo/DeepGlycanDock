...
def initConformer(lig_mol,inference_mode='Screen'):
    ...
    return lig_mol
def get_lig_graph_with_matching(mol_, complex_graph, ligand_embedding, popsize, maxiter, matching, keep_original, num_conformers, remove_hs):
    ...
    complex_graph['ligand'].ligand_embedding = torch.tensor(ligand_embedding)
