...
os.environ['MSMS_BIN']= "/home/chengxi/data/work/CBS/SurfDock/comp_surface/prepare_target/default_config/local/bin/msms"
...
os.environ['PDB2PQR_BIN']="/home/chengxi/data/work/CBS/SurfDock/comp_surface/prepare_target/default_config/pdb2pqr-linux-bin64-2.1.1/pdb2pqr"
if 'PDB2PQR_BIN' in os.environ:
  ...
  sys.exit(1)
os.environ['APBS_BIN']="/home/chengxi/data/work/CBS/SurfDock/comp_surface/prepare_target/default_config/local/bin/apbs"
if 'APBS_BIN' in os.environ:
   apbs_bin = os.environ['APBS_BIN']
else:
  print("ERROR: APBS_BIN not set. Variable should point to APBS program.")
  sys.exit(1)
os.environ['MULTIVALUE_BIN']="/home/chengxi/data/work/CBS/SurfDock/comp_surface/prepare_target/default_config/local/share/apbs/tools/bin/multivalue"
